...
<html lang="pt-br">
    <head>
        ...
        <title>Esqueci minha Senha - <?php echo $configs->name; ?></title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="card cntlog">
                        <div class="card-body">
                            <h5 class="card-title text-center mb-4"><i class="fa-sharp fa-solid fa-utensils text-primary"></i> &nbsp; Esqueci a senha</h5>
                            <form>
                                <div class="mb-3">
                                    <label for="username" class="form-label"><small><i class="fa-solid fa-envelope text-muted"></i></small> &nbsp;<b>E-mail</b> / <small><i class="fa-solid fa-user text-muted"></i></small> &nbsp;<b>Usuário</b></label>
                                    <input type="text" class="form-control" id="inputEmail" autocomplete="off" placeholder="Escreva seu E-mail ou Usuário" required>
                                </div>
                                <div class="d-grid">
                                    <button type="button" class="btn btn-primary">Redefinir Senha</button>
