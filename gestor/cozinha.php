...
if (!$container->TestAcess('cozinha')) {
    header("Location: index");
    exit();
}
?>
...
<html lang="pt-br">
    <head>
        ...
        <title>Cozinhas - <?php echo $configs->name; ?></title>
        ...
        <script>
            var paginacarregada = false;

            function AbrirLink(link) {
                $('#ModalLoading').modal('show');
                window.location.href = link;
            }
            function AlertaPed(id) {
                var obj = document.getElementById(id);
                if (obj.classList.contains('text-bg-primary')) {
                    obj.classList.remove('text-bg-primary');
                    obj.classList.add('text-bg-danger');
                    return;
                }
                if (obj.classList.contains('text-bg-danger')) {
                    obj.classList.remove('text-bg-danger');
                    obj.classList.add('text-bg-primary');
                    return;
                }
            }
    ...
    <body onload="paginacarregada = true;">
        ...
        <main class="principal">
            <div class="p-3 text-bg-dark menulateral">
                ...
                <hr>
                <?php
                echo $container->WriteMenu('cozinha');
                ?>
                <hr>
                <?php
            ...
            <div class="conteudo">
                <h4><small><i class="bi pe-none me-2 fa-solid fa-utensils text-muted"></i></small>Cozinha</h4>
                <hr>
                <div class="container text-center">
                    <div class="row">
                        <div class="col border-right">
                            <p class="text-primary"><b>Novos</b></p>
                        </div>
                        <div class="col">
                            <p class="text-muted"><b>Em Andamento</b></p>
                        </div>
                        <div class="col border-left">
                            <p class="text-success"><b>Prontos</b></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col border-right">
                            <div class="card text-bg-primary cardprod">
                                <div class="card-body">
                                    <h5 class="card-title">PED #123</h5>
                                    <p class="card-text">1x Pizza Calabresa Grande<br><small>(Sem cebola)</small></p>
                                    <p class="card-text">1x Coca-Cola 1Lt</p>
                                </div>
                            </div>
                            <br>
                            <div id="PED123" class="card text-bg-primary cardprod">
                                <div class="card-body">
                                    <h5 class="card-title">PED #471 <small><span class="badge text-bg-danger"><i class="fa-solid fa-stopwatch"></i></span></small></h5>
                                    <p class="card-text">3x Hambúrguer X-Tudo</p>
                                    <p class="card-text">1x Hambúrguer X-Egg</p>
                                    <p class="card-text">1x Coca-Cola 2Lt</p>
                                </div>
                            </div>
                            <br>
                            <div id="PED124" class="card text-bg-primary cardprod">
                                <div class="card-body">
                                    <h5 class="card-title">PED #471 <small><span class="badge text-bg-danger"><i class="fa-solid fa-stopwatch"></i></span></small></h5>
                                    <p class="card-text">3x Hambúrguer X-Tudo</p>
                                    <p class="card-text">1x Hambúrguer X-Egg</p>
                        ...
                        <div class="col">
                            <div class="card text-bg-secondary cardprod">
                                <div class="card-body">
                                    <h5 class="card-title">PED #471</h5>
                                    <p class="card-text">3x Hambúrguer X-Tudo</p>
                                    <p class="card-text">1x Hambúrguer X-Egg</p>
                                    <p class="card-text">1x Coca-Cola 2Lt</p>
                                </div>
                        ...
                        <div class="col border-left">
                            <div class="card text-bg-success cardprod">
                                <div class="card-body">
                                    <h5 class="card-title">PED #952</h5>
                                    <p class="card-text">1x Pizza Calabresa Grande<br><small>(Sem cebola)</small></p>
                                    <p class="card-text">1x Coca-Cola 1Lt</p>
                                </div>
                            </div>
